...
export const EditScheduleRoomModalController: React.FC<
    EditScheduleRoomModalControllerProps
> = ({ onScheduledRoom, children }) => {
                ...
                <CreateScheduleRoomModal
                    editInfo={{
                        ...
                        intialValues: {
                            cohosts: [],
                            description:
                                editInfo.scheduleRoomToEdit.description,
                            name: editInfo.scheduleRoomToEdit.name,
                            scheduledFor: new Date(
                                editInfo.scheduleRoomToEdit.scheduledFor
                            ),
                        },
                    }}
                    onScheduledRoom={(...vals) =>
                        onScheduledRoom(editInfo, ...vals)
                    }
