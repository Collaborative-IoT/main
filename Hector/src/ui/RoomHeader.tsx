...
export const RoomHeader: React.FC<RoomHeaderProps> = ({
    ...
    const { current_room_base_data, all_users_in_room, user } =
    ...
    const gather_owner_user_name = () => {
        ...
        if (all_users_in_room && current_room_base_data) {
            for (var user_key of all_users_in_room!!.keys()) {
                if (
                    all_users_in_room.get(user_key)!!.user_id ===
        ...
        >
            ...
            <div className={`flex text-primary-200 text-sm`}>
                ...
                <span
                    ...
                    style={{ marginRight: 4 }}
                >
                    {current_room_base_data && all_users_in_room
                        ? gather_owner_user_name()
                        : "loading..."}
                </span>
            </div>
