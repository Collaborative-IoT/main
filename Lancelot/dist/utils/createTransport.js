...
const log = (0, debug_1.default)("shawarma:create-transport");
const transportToOptions = ({ id, iceParameters, iceCandidates, dtlsParameters, }) => ({ id, iceParameters, iceCandidates, dtlsParameters });
